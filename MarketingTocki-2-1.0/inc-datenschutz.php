...
<p>
	Der Schutz Ihrer Privatsphäre ist für uns sehr wichtig. Nachstehend informieren wir 
...
<p>
	Wir sind bestrebt, Ihnen so viel Kontrolle wie möglich über Ihre persönlichen
	Daten einzuräumen. Für uns ist es wichtig, dass Sie sich bei Ihrem Besuch auf 
	unserer Website wohl fühlen. Manchmal benötigen wir von Ihnen gleichwohl bestimmte 
	Angaben. Alle Ihre persönlichen Angaben, einschließlich Ihrer E-Mailadresse, 
	werden von uns nur dann erhoben, wenn Sie uns diese von sich aus 
	(also beim Ausfüllen des Kontaktformulars) angeben.
</p>

<h3>Nutzung und Weitergabe personenbezogener Daten</h3>
<p>
	Daten, die Sie im Rahmen dieser Website übermitteln, werden ausschließlich 
	für den angegebenen Zweck verarbeitet und genutzt. Darüber hinaus erfolgt 
	keine weitere Verarbeitung und Nutzung Ihrer Daten für weitere Zwecke. 
	Selbstverständlich findet keine Weitergabe Ihrer Daten statt. Auf Wunsch 
	erteilen wir Ihnen unentgeltlich Auskunft über alle personenbezogenen Daten, 
	die wir über Sie gespeichert haben. Des Weiteren können Sie Ihre Einwilligung 
	jederzeit widerrufen. Der Widerruf gilt dann für die Zukunft.
</p>

<h3>Auskunftsrecht</h3>
<p>
	Nach dem Bundesdatenschutzgesetz haben Sie ein Recht auf unentgeltliche Auskunft 
	über Ihre gespeicherten Daten sowie ggf. ein Recht auf Berichtigung, Sperrung oder 
...
<p>
	...
	das Cookie erzeugten Informationen über Ihre Benutzung dieser Website werden in der Regel 
	...
	<a href="http://tools.google.com/dlpage/gaoptout?hl=de" target="_blank">Link</a> verfügbare Browser-Plugin 
	herunterladen und installieren.
</p>
<p>
	Sie können die Erfassung durch Google Analytics verhindern, indem Sie auf folgenden Link klicken. 
	Es wird ein Opt-Out-Cookie gesetzt, das die zukünftige Erfassung Ihrer Daten beim Besuch dieser 
	Website verhindert: <a href="#" onclick="gaOptOut();return false;">Google Analytics deaktivieren</a>
</p>
<p>
	Nähere Informationen zu Nutzungsbedingungen und Datenschutz finden Sie unter 
	<a href="http://www.google.com/analytics/terms/de.html" target="_blank">http://www.google.com/analytics/terms/de.html</a> 
	bzw. unter <a href="https://www.google.de/intl/de/policies" target="_blank">https://www.google.de/intl/de/policies/</a>. 
