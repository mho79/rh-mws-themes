    ...
    <div class="wrapper footer-wrapper">
        ...
        <div class="footer">
            ...
            <?php } else { ?> <!-- Daten aus Theme Optionen werden angezeigt -->
                <div class="footer-links">
                    <span class="fl-firma"><?php  if (!empty($tocki_redux_themeoptions["tocki_redux_firma"])) { ?><?php echo $tocki_redux_themeoptions["tocki_redux_firma"]; echo " // "; }; ?></span>
                    <span class="fl-zusatz"><?php  if (!empty($tocki_redux_themeoptions["tocki_redux_firma_zusatz"])) { ?><?php echo $tocki_redux_themeoptions["tocki_redux_firma_zusatz"]; echo " // "; }; ?></span>
                    <span class="fl-strasse"><?php  if (!empty($tocki_redux_themeoptions["tocki_redux_strasse"])) { ?><?php echo $tocki_redux_themeoptions["tocki_redux_strasse"]; echo " // "; }; ?></span>
                    <span class="fl-plz"><?php  if (!empty($tocki_redux_themeoptions["tocki_redux_plz"])) { ?><?php echo $tocki_redux_themeoptions["tocki_redux_plz"]; }; ?></span> <span class="fl-ort"><?php  if (!empty($tocki_redux_themeoptions["tocki_redux_ort"])) { ?><?php echo $tocki_redux_themeoptions["tocki_redux_ort"]; }; echo " // "; ?></span>
...
<script type="text/javascript" src="<?php bloginfo( 'stylesheet_directory' ); ?>/js/jquery.fadeSliderToggle.js"></script> <!-- Fade Slide Toggle Plugin  -->
<script type="text/javascript" src="<?php bloginfo( 'stylesheet_directory' ); ?>/js/messages.de.js"></script><!-- Form Validation -->	
<script type="text/javascript" src="<?php bloginfo( 'stylesheet_directory' ); ?>/js/parsley.js"></script><!-- Form Validation -->	
