...
------------------------------------------------------------------------------------------------------ */
			...
			$this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'editor',
                        'title' => 'Impressum Spalte 1',
                        'subtitle' => 'Werte aus dem Proxy verwenden:<br> <span style="color: #0074A2; font-weight: bold;">{admin.customer.contact_person} <br>{admin.customer.street} <br>{admin.customer.zipcode} {admin.customer.city} <br>{admin.customer.email}</span>',
			...
			$this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'title' => 'Logo-Breite',
                        'desc' => 'Die tatsächliche Breite des oberen Logos im Logobild. (Nicht die Gesamtbreite der Logodatei!)',
                        'default' => '350px',
                    ),
                    array(
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'title' => 'Header Höhe',
                        'subtitle' => 'Die minimale Höhe des Headers in Pixel',
                        'default' => '150px',
                    ),				
                    array(
                    ...
                    array(
                        'id' => 'tocki_redux_colorextend_menu_normal',
                        'required' => array('tocki_redux_colorextend', 'equals', '1'),
                        'type' => 'color',
                        'title' => 'Menü: Normaler Menüpunkt',
                        'validate' => 'color',
                    ),
                    array(
                    ...
                    array(
                        'id' => 'tocki_redux_colorextend_menu_height_normal',
                        'required' => array('tocki_redux_colorextend', 'equals', '1'),
                        'type' => 'text',
                        'title' => 'Menü: Höhe Ausgangspunkt',
                        'default' => '160px',
                    ),
                    array(
                        'id' => 'tocki_redux_colorextend_menu_height_small',
                        'required' => array('tocki_redux_colorextend', 'equals', '1'),
                        'type' => 'text',
                        'title' => 'Menü: Höhe schmal',
                        'default' => '80px',
                    ),
                    array(
			...
			$this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id' => 'tocki_redux_code_css_715',
                        'type' => 'ace_editor',
                        'title' => 'CSS max-width: 715px',
                        'subtitle' => 'Erste responsive-Stufe',
						'default' => '@media all and (max-width: 715px) {
...
*/
            ...
            $this->args['footer_text'] = __('<p>WP Theme Magic Version 2 von Tilman Ockert und Dennis Hipp f&uuml;r RegioHelden</p>', 'redux-framework-demo');
        }
