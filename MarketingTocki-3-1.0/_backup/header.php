...
<?php if (!empty($tocki_redux_themeoptions["tocki_redux_header_img_height"])) { ?>.header-image{ min-height: <?php echo $tocki_redux_themeoptions["tocki_redux_header_img_height"]; ?>}<?php }; ?>
...
<?php if ($tocki_redux_themeoptions['tocki_redux_colorextend'] == 1) { ?>
	<?php if (!empty($tocki_redux_themeoptions["tocki_redux_colorextend_header_cta"])) { ?>.colorextend-header-cta{ color: <?php echo $tocki_redux_themeoptions["tocki_redux_colorextend_header_cta"]; ?>;}<?php }; ?>
...
<?php if (!empty($tocki_redux_themeoptions["tocki_redux_code_css_715"])) { ?><?php echo $tocki_redux_themeoptions["tocki_redux_code_css_715"];}; ?>
    ...
    <div class="header-image" <?php if (has_post_thumbnail($post->ID)) { ?>style="background: url(<?php $thumbnail_src = wp_get_attachment_image_src(get_post_thumbnail_id(), 'full');echo $thumbnail_src [0];?>) no-repeat;"<?php } ?>>        
		...
		?>
			...
			if($post->post_parent) {
			  ...
			  if ($children) { ?>
			<nav id="nav" class="menu-menu-1-container"><a href="#nav" title="Menü anzeigen">Menü <i class="fa fa-angle-down fa-1x"></i></a><a href="#" title="Menü verbergen">Menü <i class="fa fa-angle-up fa-1x"></i></a>
